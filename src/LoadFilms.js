    ...
    componentWillMount(){
            ...
            this.props.films.map(film => {
                switch(film){
                    ...
                    case 'https://swapi.co/api/films/2/':this.setState({
                        episode2:true
                    });break;
                    case 'https://swapi.co/api/films/3/': this.setState({
                        episode3:true
                    });break;
                    case 'https://swapi.co/api/films/4/': this.setState({
                        episode4:true
                    });break;
                    case 'https://swapi.co/api/films/5/': this.setState({
                        episode5:true
                    });break;
